import 'package:base_flutter/views/infor_from_shared_preference.dart';
...
class _HomeScreenState extends State<HomeScreen> {
            ...
            children: [
              ...
              confirmButtonWidget(
                  ...
                  onPressed: (){
                    ...
                    saveInformationToSharedPreferenceDb(
                        userNameAndAge: "Họ Tên: $userName" + "\n" + "Tuổi: $age" );
                  }),
              const SpaceWidget(),
              informationWidget(
              ...
              ElevatedButton(
                  onPressed: (){
                    var route = MaterialPageRoute(builder: (context)=>
                        InforFromSharedPreference());
                    Navigator.push(context, route);
                  },
                  child: Text("Next Page To SharedPreferenceView")),
  ...
  saveInformationToSharedPreferenceDb({ required String? userNameAndAge}) async {
    final prefs = await _prefs;
    await prefs.setString("information", userNameAndAge!);
  }
