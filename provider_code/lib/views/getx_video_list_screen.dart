...
class GetXVideoListScreen extends StatefulWidget {
  const GetXVideoListScreen({Key? key}) : super(key: key);

  @override
  _GetXVideoListScreenState createState() => _GetXVideoListScreenState();
}

class _GetXVideoListScreenState extends State<GetXVideoListScreen> {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(onPressed: (){
            Get.to(GetXVideoListSecondScreen());
